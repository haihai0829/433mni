...
cmd.rrpc = {
	--add
	["alldevice"] = function(t)  return all()  end,
	["allykq"] = function(t)  return allykq()  end,
	...
	["setpio"] = function(t) sys.timerStart(pins.setup(pio.P0_5,0), 60000)  return "hi" end,
    ["getpio"] = function(t) if pios["pio" .. t[1]] then return "{\"GPIO\":\"" .. t[1] .. pios["pio" .. t[1]]().."\"}" end return "ERROR" end,
...
function all()
    ...
    return('{"alldevicecode":"' .. alldevicecode .. '"}')
end
--all end
